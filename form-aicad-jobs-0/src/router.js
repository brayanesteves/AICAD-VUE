    ...
    },
    {
      ...
      children: [
        ...
        // A - SETTINGS OPTION'S
        {
          path: "settings",
          name: "ajustes",
          component: () => import("@/views/profile/main/ajustes.vue"),
          meta: "any"
        },
        ...
        {
          path: "/ajustes/datos-acceso/change-email",
          name: "change-email",
        ...
        {
          path: "/ajustes/datos-acceso/change-password",
        ...
        {
          path:
            "/ajustes/notificaciones-y-consejos/alertas-de-empleo-por-email",
          name: "alertas-de-empleo-por-email",
          component: alertEmployeEmail
        },
        ...
        {
          path: "/ajustes/notificaciones-y-consejos/settings-comunications",
          name: "settings-comunications",
          component: settingsComunications
        },
        //  -o-o-o-o-o-o-o-o-o-o-o-o-o-o-o-o-o-o-o-o-o-o-o-o-o-o-o-o-o-o-o-o- //
        ...
        {
          path: "/ajustes/privacy/settings-privacy",
        ...
        //  SECTION Nº0 - ACCESS DATA
        {
          path: "/help/access-data/question-password",
          name: "question-password",
          component: questionPassword
        },
        {
          path: "/help/access-data/not-email-sent",
          name: "not-email-sent",
          component: notEmailSent
        },
        {
          path: "/help/access-data/not-access-profile",
          name: "not-access-profile",
          component: notAccessProfile
        },
        {
          path: "/help/access-data/question-email-password",
          name: "question-email-password",
          component: questionEmailPassword
        },
        // SECTION Nº1 - CV my data
        {
          path: "/help/cv-my-data/question-my-cv",
          name: "question-my-cv",
          component: questionMyCV
        },
        {
          path: "/help/cv-my-data/create-update-cv",
          name: "create-update-cv",
          component: createUpdateCV
        },
        {
          path: "/help/cv-my-data/create-add-present",
          name: "create-add-present",
          component: createAddPresent
        },
        {
          path: "/help/cv-my-data/profile-visible",
          name: "profile-visible",
          component: profileVisible
        },
        {
          path: "/help/cv-my-data/protected-aicad-jobs",
          name: "protected-aicad-jobs",
          component: protectedAICADJobs
        },
        // SECTION Nº2 - (OFFERS AND RECOMMENDATIONS)
        {
          path: "/help/offers-and-recommendations/repeated-or-fraudulent",
          name: "repeated-or-fraudulent",
          component: repeatedOrFraudulent
        },
        {
          path: "/help/offers-and-recommendations/offers-for-you",
          name: "offers-for-you",
          component: offersForYour
        },
        // SECTION Nº3 - (REGISTRATIONS AND APPLICATIONS)
        {
          path: "/help/registrations-and-applications/cant-signup-offers",
          name: "cant-signup-offers",
          component: cantSignupOffers
        },
        {
          path: "/help/registrations-and-applications/candidate-states-exist",
          name: "candidate-states-exist",
          component: candidateStatesExist
        },
        {
          path: "/help/registrations-and-applications/dont-companies-callme",
          name: "dont-companies-callme",
          component: dontCompaniesCallme
        },
        {
          path: "/help/registrations-and-applications/can-change-myCV",
          name: "can-change-myCV",
          component: canChangemyCV
        },
        {
          path:
            "/help/registrations-and-applications/limit-of-dailyRegistration",
          name: "limit-of-dailyRegistration",
          component: limitOfDailyRegistration
        },
        // SECTION Nº4 - (EMAIL NOTIFICATIONS ALERTS)
        {
          path:
            "/help/email-notificatons-alerts/difference-notificationsAlerts",
          name: "difference-notificationsAlerts",
          component: differenceNotificationsAlerts
        },
        {
          path: "/help/email-notificatons-alerts/stoped-offers",
          name: "stoped-offers",
          component: stoppedOffers
        },
        // SECTION Nº5 - (CONTACT NETWORK)
        {
          path: "/help/contact-network/where-aicadjobs",
          name: "where-aicadjobs",
          component: whereAICADJobs
        },
        // SECTION Nº6 - (WHO SEES ME)
        {
          path: "/help/who-sees-me/received-visitors",
          name: "received-visitors",
          component: receivedVisitors
        },
        // SECTION Nº7 - (EXECUTIVE ACCOUNT)
        {
          path: "/help/executive-account/activated-executive",
          name: "activated-executive",
          component: activatedExecutive
        },
        // SECTION Nº8 - (UNSUBSCRIBE)
        {
          path: "/help/unsubscribe/unsubscribe-aicadjobs",
          name: "unsubscribe-aicadjobs",
          component: unsubscribeAICADJobs
        },
        {
          path: "/help/unsubscribe/unsubscribe",
          name: "unsubscribe",
