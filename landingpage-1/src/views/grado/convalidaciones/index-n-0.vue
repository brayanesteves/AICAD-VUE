<template>
	...
	<h1 class="u-hidden">Convalidaciones y traslado de expediente</h1>
		...
		<section class="c-hero-convalidaciones">
			<div class="wrapper">
				<p class="c-hero-convalidaciones__title u-bold title-convalidaciones">Convalidaciones</p>
			...
			<div class="wrapper">
				...
				<div class="list-description__container">
					<div class="list-description__item">
						...
						<p><strong>Recopila la información</strong> necesaria antes de comenzar tu solicitud: <span class="txt-small">certificado académico oficial de notas de tu universidad de origen o tus calificaciones del ciclo formativo de Grado Superior.</span></p>
					</div>
					<div class="list-description__item">
						<span class="number__description u-color-grado">02.</span>
						<p> <strong>Solicita tu estudio de convalidaciones.</strong> Lo evaluaremos y te daremos respuesta en la mayor brevedad posible.</p>					</div>
	...
	<section class="c-form-university c-form-mod-becas-ayudas " style="display:none">
		...
		<input type="hidden" name="pagina" value="grado/convalidaciones/">
		<input type="hidden" name="origen" value="">
		<input type="hidden" name="originCampaignId" value="">
		<input type="hidden" name="validar_hashcash_admisiones" value="rmoViMVHzWVrBShU9G5f">
...
<option value="187">Zimbabwe</option>
		  ...
		  <section class="c-form-university__foot">
			<div class="material-input material-check u-align-center check-politics">
			  ...
			  <p>He leído y acepto la <a class="modal__btn" href="#" data-modal="#popup__privacidad">política de protección de datos*</a></p>
			</div>
