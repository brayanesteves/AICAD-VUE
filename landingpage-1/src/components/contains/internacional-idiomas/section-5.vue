    ...
    <section class="c-content-idiomas">
			<div class="wrapper">
				...
				<ul class="c-content-idiomas__listado">
					<li>En AICAD Idiomas somos centro preparador y examinador de los principales exámenes oficiales y certificados, tanto del ámbito profesional como académico: <strong> Cambridge y TOEFL</strong>.
						<div class="c-content-idiomas__logos">
							<a v-for="lang in logos_idiomas" :key="lang" :href="lang.href"><img :src="lang.img" :alt="lang.alt"></a>
						</div>
					</li>
            ...
            logos_idiomas: [
                {
                    ...
                    img:'../imagenes/mobile/university/cambridge.png',
                    alt:'Cambridge English',
                },
                {
                    href:'https://capman.es/es',
                    img:'../imagenes/mobile/university/logo-toefl.png',
                    alt:'TOEFL',
                },
                {
                    href:'https://www.cervantes.es/default.htm',
                    img:'../imagenes/mobile/university/cervantes-logo.png',
                    alt:'Instituto Cervantes',
                },
                {
                    href:'https://examenes.cervantes.es/es/dele/que-es',
                    img:'https://examenes.cervantes.es/sites/all/themes/examenes_zen/images/dele-logo.png',
                    alt:'DELE',
                }
            ]
        }
